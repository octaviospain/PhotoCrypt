 ...
 */
public class DefaultErrorCaseTest {

    @Test
    @DisplayName ("Title")
    void titleTest() {
        assertEquals("ENCRYPT_DECRYPT", DefaultErrorCase.CRYPTO_ERROR.title());
    }

    @Test
    @DisplayName("toString")
    void toStringTest() {
        assertEquals("ITEM_NOT_ENCRYPTED_Media item is not encrypted", DefaultErrorCase.ITEM_NOT_ENCRYPTED.toString());
    }
}